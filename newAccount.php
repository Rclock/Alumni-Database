...
function doSubmitThree(e){
    setTimeout(function(){location.href="half.html"} , 30);
}
                ...
                <div class="d-flex justify-content-center h-100">
                    <div class="card">
                        ...
                        else if (1)//
                        {
                            ...
                            $query2 = "select username from Users where username='$user' and password='$pass' and adminpriv=0";

                            if ($connection->query($query1) == TRUE){
                                //if the query is valid enter the if statement
                            ...
                            } elseif ($connection->query($query2) == TRUE){
